...
def distance_objects(object_1: ObjectType, object_2: ObjectType) -> float:
    """Calculates the 3D/2D center distance between two objects.
    ...
    Returns:
    --------
        float: The center distance between object_1 and object_2.
    """
...
def distance_objects_bev(object_1: DynamicObject, object_2: DynamicObject) -> float:
    """Calculates the BEV 2d center distance between two objects.
    ...
    Returns:
    --------
        float: The 2d center distance from object_1 to object_2.
    """
