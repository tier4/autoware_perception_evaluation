...
class DynamicObject:
    ...
    def get_footprint(self, scale: float = 1.0) -> Polygon:
        ...
        logging.info(f"Yaw Pitch Roll:{self.state.orientation.yaw_pitch_roll}, Ftpt:{rotated_footprint[0]}, Mag:{self.state.orientation.magnitude}")
        logging.info(f"Q:{self.state.orientation.q}")
