...
def _get_box_velocity(
    ...
    # Transform position displacement coords from map to object -> just rotate
    object2map = HomogeneousMatrix((0.0, 0.0, 0.0), first["rotation"], src=FrameID.OBJECT, dst=FrameID.MAP)
    pos_diff: NDArray = object2map.inv().transform(pos_diff)
