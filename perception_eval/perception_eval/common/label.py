...
def _get_autoware_pairs(merge_similar_labels: bool) -> List[Tuple[AutowareLabel, str]]:
    ...
    pair_list: List[Tuple[AutowareLabel, str]] = [
        ...
        (AutowareLabel.CAR, "police_car"),
        (AutowareLabel.CAR, "forklift"),
        (AutowareLabel.CAR, "ambulance"),
        (AutowareLabel.CAR, "kart"),
        ...
        (AutowareLabel.CAR, "other_vehicle"),
        ...
        (AutowareLabel.PEDESTRIAN, "police_officer"),
        (AutowareLabel.PEDESTRIAN, "construction_worker"),
        (AutowareLabel.PEDESTRIAN, "wheelchair"),
        (AutowareLabel.PEDESTRIAN, "personal_mobility"),
        (AutowareLabel.PEDESTRIAN, "other_pedestrian"),
        ...
        (AutowareLabel.HAZARD, "static_object.bicycle rack"),
        (AutowareLabel.HAZARD, "static_object.bicycle_rack"),
    ...
    if merge_similar_labels:
        pair_list += [
            ...
            (AutowareLabel.CAR, "semi_trailer"),
            (AutowareLabel.CAR, "vehicle.construction"),
            (AutowareLabel.CAR, "vehicle.fire"),
            (AutowareLabel.CAR, "fire_truck"),
            (AutowareLabel.CAR, "tractor_unit"),
            (AutowareLabel.CAR, "construction_vehicle"),
        ...
        pair_list += [
            ...
            (AutowareLabel.TRUCK, "semi_trailer"),
            (AutowareLabel.TRUCK, "vehicle.construction"),
            (AutowareLabel.TRUCK, "vehicle.fire"),
            (AutowareLabel.TRUCK, "fire_truck"),
            (AutowareLabel.TRUCK, "tractor_unit"),
            (AutowareLabel.TRUCK, "construction_vehicle"),
